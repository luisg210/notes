  ...
  return (
    <>
      ...
      >
        ...
        <Grid item xs={12} marginBottom={2} marginTop={2} width={250}>
          <TextField
            label="Username"
            name="loginUser"
            required
        ...
        <Grid marginBottom={2} marginTop={2} item xs={12} width={250}>
          <TextField
            label="Password"
            type="password"
            name="loginPassword"
...
{/* 
      ...
      >
        ...
        <Grid item marginBottom={2} marginTop={2} xs={12} width={250}>
          <TextField
            label="Name"
            name="newName"
            required
        ...
        <Grid item marginBottom={1} marginTop={1} xs={12}>
          <Button type="submit" size="large" color="success" variant="contained" >Register</Button>
        </Grid>
